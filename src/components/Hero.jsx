...
const Hero = () => {
  ...
  const fullText = 'API 설계부터 화면 구현까지 직접 연결하는 백엔드 중심 풀스택 개발자';
      ...
      <div className="mx-auto max-w-5xl px-4 py-32 text-center">
        <div className="space-y-8 animate-fade-in-up">
          ...
          <p className="text-lg md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            빠른 UI, 견고한 API, 프로덕션급 인프라를 설계합니다. 
            <br />
            <span className="font-semibold text-gray-900 dark:text-white">AI/RAG</span>와 <span className="font-semibold text-gray-900 dark:text-white">실시간 협업</span>에 집중합니다.
          </p>
